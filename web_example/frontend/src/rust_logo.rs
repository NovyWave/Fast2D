...
use fast2d::zoon::wasm_bindgen::throw_str;
use fast2d::zoon::{println, *};
...
pub fn run(canvas: fast2d::zoon::web_sys::HtmlCanvasElement) {
...
fn create_graphics(
    ...
    canvas: fast2d::zoon::web_sys::HtmlCanvasElement,
...
impl Application {
    fn new(event_loop: &EventLoop<UserEvent>, canvas: fast2d::zoon::web_sys::HtmlCanvasElement) -> Self {
